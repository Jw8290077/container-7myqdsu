...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-7myqdsu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-7myqdsu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Jw8290077/container-7myqdsu.git
cd container-7myqdsu
```
...
```
docker attach container-7myqdsu
```
